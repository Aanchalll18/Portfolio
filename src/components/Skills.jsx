...
//       <div className='flex flex-col md:flex-row justify-center space-y-8 md:space-x-8 md:space-y-0 max-w-[3000px] mx-auto'>
...
const Skills = () => {
	return (
		...
		>
			...
			<div className="flex flex-col md:flex-row justify-center space-y-8 md:space-x-8 md:space-y-0 max-w-[1200px] mx-auto">
				{skills.map((skill, index) => (
					<div
						key={index}
						className="border border-purple-900 p-8 rounded-lg bg-purple-900/20 shadow-lg w-full md:w-1/2"
					>
